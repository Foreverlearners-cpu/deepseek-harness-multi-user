...
- **Connection-only API** — transactions, migrations, error classification, query timeouts, cancellation, health reporting, and observability are not implemented yet.
