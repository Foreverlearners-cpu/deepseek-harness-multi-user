...
import type { AuthenticatedCall, AuthenticationRequestId } from '@deepseek-ai/dsh-auth/types'
import type { LoginIdentifierInput } from '@deepseek-ai/dsh-user-credential/types'
import type { UserExtensions, UserRecord } from '@deepseek-ai/dsh-user/types'
