...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  conversationPersistence: 'persistence.md',
  runtimeConfigs: 'persistence.md',
  users: 'persistence.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ModelAttempt: 'conversation attempt projection is owned by packages/session/conversation-persistence-mysql/README.md',
  ConversationOutboxEvent: 'conversation outbox contract is owned by packages/session/conversation-persistence-mysql/README.md',
  Conversation: 'conversation projection contract is owned by packages/session/conversation-persistence-mysql/README.md',
  CreateConversationInput: 'conversation creation input is owned by packages/session/conversation-persistence-mysql/README.md',
  ConversationMessage: 'conversation message projection is owned by packages/session/conversation-persistence-mysql/README.md',
  HydratedSession: 'message-only session projection is owned by packages/session/conversation-persistence-mysql/README.md',
  AppendMessageInput: 'final-message append input is owned by packages/session/conversation-persistence-mysql/README.md',
  ConversationTitleStatus: 'conversation title state is owned by packages/session/conversation-persistence-mysql/README.md',
  JsonObject: 'bounded extension object is owned by packages/session/conversation-persistence-mysql/README.md',
  ConversationFile: 'conversation file metadata is owned by packages/session/conversation-persistence-mysql/README.md',
  RegisterFileInput: 'conversation file registration input is owned by packages/session/conversation-persistence-mysql/README.md',
  RuntimeConfig: 'runtime configuration row is owned by packages/session/conversation-persistence-mysql/README.md',
  RuntimeConfigInput: 'runtime configuration input is owned by packages/session/conversation-persistence-mysql/README.md',
  RuntimeConfigListener: 'runtime configuration listener is owned by packages/session/conversation-persistence-mysql/README.md',
  FileObjectRef: 'file object reference is owned by packages/storage/file-storage/README.md',
  CreateUserInput: 'user creation input is owned by packages/identity/user/README.md',
  User: 'user identity record is owned by packages/identity/user/README.md',
  UserId: 'user identity brand is owned by packages/identity/user/README.md',
  ...
  MysqlTransactionConnection: 'transaction lease façade contract is owned by packages/multi/mysql/README.md',
