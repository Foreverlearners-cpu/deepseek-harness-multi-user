...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  authGateway: 'authentication.md',
  authTokens: 'auth-token.md',
  userCredentials: 'user-credentials.md',
  users: 'user-directory.md',
  tenants: 'tenant-directory.md',
  teams: 'team-directory.md',
  authority: 'authority.md',
  authRbac: 'auth-rbac.md',
  authorityAcl: 'authority-acl.md',
  tenantAuthority: 'tenant-authority.md',
  accountAuthority: 'account-authority.md',
  ...
  sessionProjectionReconciler: 'session-projection.md',
  sessionProjections: 'session-projection.md',
  sessionCdcStarter: 'session.md',
  sessions: 'session.md',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'user-credential': 'user-credentials.md',
  'user': 'user-directory.md',
  'tenant': 'tenant-directory.md',
  'team': 'team-directory.md',
  'approval': 'approval.md',
  'commands': 'commands.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AccountAdminAction: 'authentication.md',
  AccountAdminAuthorizationRequest: 'authentication.md',
  AccountAdminAuthorizer: 'authentication.md',
  AccountAuthority: 'account-authority.md',
  ...
  GatewayHttpAuthenticationRequest: 'authentication.md',
  GatewayLoginRequest: 'authentication.md',
  GatewayLogoutResult: 'authentication.md',
  GatewayRegistrationRequest: 'authentication.md',
  ...
  AuthTokenChangeEvent: 'auth-token.md',
  AuthTokenInspectRequest: 'auth-token.md',
  AuthTokenInspection: 'auth-token.md',
  AuthTokenRevokeRequest: 'auth-token.md',
  AuthTokenService: 'auth-token.md',
  ...
  IssuedRefreshToken: 'auth-token.md',
  PreparedTokenFamilyIssueResult: 'auth-token.md',
  ProviderRegistration: 'authentication.md',
  RefreshTokenRotateRequest: 'auth-token.md',
  TokenFamilyInfo: 'auth-token.md',
  TokenFamilyIssueRequest: 'auth-token.md',
  TokenFamilyIssueResult: 'auth-token.md',
  TokenFamilyPreparation: 'auth-token.md',
  UserChangeEvent: 'user-directory.md',
  UserCreateInput: 'user-directory.md',
  UserDirectory: 'user-directory.md',
  UserId: 'user-directory.md',
  UserListQuery: 'user-directory.md',
  UserPage: 'user-directory.md',
  UserRecord: 'user-directory.md',
  UserStatusRequest: 'user-directory.md',
  UserUpdateRequest: 'user-directory.md',
  MembershipId: 'tenant-directory.md',
  MembershipPage: 'tenant-directory.md',
  MembershipRecord: 'tenant-directory.md',
  MembershipStatusRequest: 'tenant-directory.md',
  TenantChangeEvent: 'tenant-directory.md',
  TenantCreateInput: 'tenant-directory.md',
  TenantDirectory: 'tenant-directory.md',
  TenantId: 'tenant-directory.md',
  TenantMemberAddRequest: 'tenant-directory.md',
  TenantMemberListQuery: 'tenant-directory.md',
  TenantMembershipChangeEvent: 'tenant-directory.md',
  TenantRecord: 'tenant-directory.md',
  TenantStatusRequest: 'tenant-directory.md',
  UserMembershipListQuery: 'tenant-directory.md',
  TeamChangeEvent: 'team-directory.md',
  TeamCreateInput: 'team-directory.md',
  TeamDirectory: 'team-directory.md',
  TeamId: 'team-directory.md',
  TeamMemberAddRequest: 'team-directory.md',
  TeamMemberListQuery: 'team-directory.md',
  TeamMembershipChangeEvent: 'team-directory.md',
  TeamMembershipId: 'team-directory.md',
  TeamMembershipPage: 'team-directory.md',
  TeamMembershipRecord: 'team-directory.md',
  TeamMembershipStatusRequest: 'team-directory.md',
  TeamRecord: 'team-directory.md',
  TeamStatusRequest: 'team-directory.md',
  UserTeamListQuery: 'team-directory.md',
  ActionCode: 'authority.md',
  ActionDefinition: 'authority.md',
  Authority: 'authority.md',
  AuthorityDecision: 'authority.md',
  AuthorityDenyCode: 'authority.md',
  AuthorityError: 'authority.md',
  AuthorityErrorCode: 'authority.md',
  AuthorityPurpose: 'authority.md',
  AuthorityRequest: 'authority.md',
  AuthorityRoute: 'authority.md',
  AuthorityRouteProvider: 'authority.md',
  AuthorityRouteQuery: 'authority.md',
  AuthorityRouteResult: 'authority.md',
  ResourceId: 'authority.md',
  ResourceRef: 'authority.md',
  ResourceResolver: 'authority.md',
  ResourceType: 'authority.md',
  TrustedResourceRef: 'authority.md',
  AuthRbac: 'auth-rbac.md',
  AuthRbacError: 'auth-rbac.md',
  AuthRbacErrorCode: 'auth-rbac.md',
  MemoryRbacPolicySource: 'auth-rbac.md',
  PrincipalRoleBinding: 'auth-rbac.md',
  PrincipalRoleQuery: 'auth-rbac.md',
  RbacPolicySource: 'auth-rbac.md',
  RoleActionSets: 'auth-rbac.md',
  RoleDefinition: 'auth-rbac.md',
  RoleId: 'auth-rbac.md',
  AclGrant: 'authority-acl.md',
  AclPolicySource: 'authority-acl.md',
  AclResourceRef: 'authority-acl.md',
  AclRoleFactQuery: 'authority-acl.md',
  AclRoleFactSource: 'authority-acl.md',
  AclSubject: 'authority-acl.md',
  AclSubjectKind: 'authority-acl.md',
  AclSubjectRef: 'authority-acl.md',
  AuthorityAcl: 'authority-acl.md',
  AuthorityAclError: 'authority-acl.md',
  AuthorityAclErrorCode: 'authority-acl.md',
  MemoryAclPolicySource: 'authority-acl.md',
  MemoryAclRoleFactSource: 'authority-acl.md',
  TenantAuthority: 'tenant-authority.md',
  TenantAuthorityDecision: 'tenant-authority.md',
  TenantAuthorityError: 'tenant-authority.md',
  TenantAuthorityErrorCode: 'tenant-authority.md',
  TenantAuthorityRequest: 'tenant-authority.md',
  TenantAuthorityScope: 'tenant-authority.md',
  TenantScopeDecision: 'tenant-authority.md',
  TenantScopeQuery: 'tenant-authority.md',
  AddLoginIdentifierRequest: 'user-credentials.md',
  ChangePasswordRequest: 'user-credentials.md',
  DisablePasswordRequest: 'user-credentials.md',
  LoginIdentifier: 'user-credentials.md',
  LoginIdentifierInput: 'user-credentials.md',
  LoginIdentifierMetadata: 'user-credentials.md',
  RemoveLoginIdentifierRequest: 'user-credentials.md',
  SetPasswordRequest: 'user-credentials.md',
  UserCredentialChangeEvent: 'user-credentials.md',
  UserCredentialRecord: 'user-credentials.md',
  UserCredentialService: 'user-credentials.md',
  VerifyPasswordRequest: 'user-credentials.md',
  ...
  ElasticsearchClient: 'multi-user-infrastructure.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  EventCodec: 'typed event codec contract is owned by packages/multi/kafka-events/README.md',
  EventRouter: 'typed event routing contract is owned by packages/multi/kafka-events/README.md',
  KafkaEventProducer: 'typed event producer contract is owned by packages/multi/kafka-events/README.md',
  KafkaEventConsumerOptions: 'typed event consumer options are owned by packages/multi/kafka-events/README.md',
  KafkaEventSubscription: 'typed event subscription handle is owned by packages/multi/kafka-events/README.md',
  KafkaEventConsumerHealth: 'typed event consumer health is owned by packages/multi/kafka-events/README.md',
  SessionCdcStarterHealth: 'starter health contract is owned by packages/session/session-cdc-starter/README.md',
  SessionProjectionSource: 'projection source contract is owned by packages/session/session-projection-reconciler/README.md',
  SessionProjectionSink: 'projection sink contract is owned by packages/session/session-projection-reconciler/README.md',
  SessionProjectionReconcileRequest: 'reconciliation request is owned by packages/session/session-projection-reconciler/README.md',
  SessionProjectionReconcileResult: 'reconciliation result is owned by packages/session/session-projection-reconciler/README.md',
  SessionProjectionReconcilerHealth: 'reconciler health contract is owned by packages/session/session-projection-reconciler/README.md',
