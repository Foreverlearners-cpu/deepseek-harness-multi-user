...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AgentStatus: 'core.md',
  AuthenticatedCall: 'identity.md',
  AuthenticationAttempt: 'identity.md',
  AuthorizationAllowDecision: 'identity.md',
  AuthorizationDecision: 'identity.md',
  AuthorizationDecisionRecord: 'identity.md',
  AuthorizationLease: 'identity.md',
  AuthorizationRequest: 'identity.md',
  ...
  PermissionCatalog: 'identity.md',
  PolicyVersion: 'identity.md',
