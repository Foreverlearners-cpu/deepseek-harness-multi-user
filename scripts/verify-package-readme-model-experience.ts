...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/session/session-cache-invalidation-redis': { kind: 'none', reason: 'The Host-only Redis invalidation Consumer registers no prompt, tool, message, or session event.' },
