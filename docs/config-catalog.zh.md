...
- `@deepseek-ai/dsh-session-message-change-protocol`（[`packages/session/session-message-change-protocol/src/index.ts`](../packages/session/session-message-change-protocol/src/index.ts)）
